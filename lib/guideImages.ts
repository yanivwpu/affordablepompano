...
export const guideImages = {
  firstTimers: {
    ...
    alt: "Pompano Beach pier and palm-lined Atlantic shoreline on a sunny day",
  },
  budgetBeachDays: {
  ...
  seasonalEvents: {
    ...
    alt: "Golden hour over the Atlantic coast at Pompano Beach",
  },
  freeThingsToDo: {
    src: "/images/guides/free-things-to-do.jpg",
    alt: "Pompano Beach fishing pier over the Atlantic Ocean at sunset",
  },
  movingToPompano: {
    src: "/images/guides/suburban-neighborhood.jpg",
    alt: "Single-family home with palm trees in a sunny South Florida neighborhood",
  },
  parkingPierTips: {
    src: "/images/guides/parking-pier-tips.jpg",
    alt: "Pompano Beach pier and shoreline with palm trees and blue Atlantic water",
  },
  happyHours: {
